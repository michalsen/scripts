...
class RedirectCheckerSpider(CrawlSpider):
    ...
    def __init__(self, domain=None, *args, **kwargs):
        ...
        self.allowed_domains = [domain] if domain else ['kidney.org']
        self.start_urls = [f'http://{domain}'] if domain else ['http://kidney.org']
        self.redirects = []
        self.not_found = []
        ...
        self.custom_settings = {
            ...
            'DOWNLOAD_DELAY': 0.5,
            'USER_AGENT': 'Mozilla/5.0 (compatible; RedirectCheckerBot/1.0; +http://kidney.org/bot)',
        }
